...
const EXAM_ID = "cambridge-igcse-english-as-a-second-language";
const EXAM_DISPLAY_NAME = "Cambridge IGCSE English as a Second Language";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover Reading, Writing, Listening, and Speaking. Focus on summary writing, note-taking, and directed writing tasks. Align to Cambridge IGCSE ESL 0510/0511.
