...
export const metadata: Metadata = {
  title: "Pricing — Cambridge Igcse English As A Second Language Premium",
  description: "Unlock unlimited Cambridge Igcse English As A Second Language practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=cambridge-igcse-english-as-a-second-language&cadence=annual`;
    ...
    <main className="min-h-screen px-4 py-12">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h1 className="mb-4 text-3xl font-bold text-zinc-900 dark:text-zinc-100">
          Cambridge Igcse English As A Second Language Premium
        </h1>
